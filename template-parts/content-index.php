    ...
    <div class="row-3 clear-bottom map-container">
        <div id="map">
            ...
            <map name="map">
                ...
                <area shape="poly"
                      ...
                      href="https://www.vidanthealth.com/medicalcenter/servicesDetail.aspx?id=586" target="_blank"
                      alt="vidant">
                <area shape="poly"
        ...
        <div class="list-container">
            <ul>
                ...
                <li>
                    <h2 class="color7">
                        <a href="https://www.vidanthealth.com/medicalcenter/servicesDetail.aspx?id=586" target="_blank">
